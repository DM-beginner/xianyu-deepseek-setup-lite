...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; irm https://raw.githubusercontent.com/DM-beginner/xianyu-deepseek-setup-lite/main/install-win11.ps1 -OutFile $env:TEMP\xs.ps1; & $env:TEMP\xs.ps1
```
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; irm https://raw.githubusercontent.com/DM-beginner/xianyu-deepseek-setup-lite/main/install-win10.ps1 -OutFile $env:TEMP\xs.ps1; & $env:TEMP\xs.ps1
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/DM-beginner/xianyu-deepseek-setup-lite/main/install-mac.sh)
```
